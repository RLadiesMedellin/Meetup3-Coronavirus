...
colombia <- filter(paises, paises$location == "Colombia") 

# Gráfica número de casos confirmados por fecha en Colombia
ggplot(data = colombia, aes(x = date, y = new_cases)) +
        geom_line(color = "red") + geom_point(color = "red") + theme_bw() + 
        labs(x = "Fecha", y = "Número de casos confirmados")

# Gráfica número de muertes por fecha en Colombia
ggplot(data = colombia, aes(x = date, y = new_deaths)) +
        geom_line(color = "red") + geom_point(color = "red") + theme_bw() + 
        labs(x = "Fecha", y = "Número de casos confirmados")
...
ggplot(data = datacolombia, aes(x = Estado, y = Edad, fill = Estado)) +
        ...
        labs(y = "Edad",
             title = "Estado vs Edad")


# Para eliminar filas con datos faltantes si es necesario
